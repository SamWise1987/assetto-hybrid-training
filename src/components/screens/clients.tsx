...
export function ClientsScreen({ admin = false }: { admin?: boolean }) {
  ...
  return (
    <div className="screen-stack staff-dashboard">
      <header className="section-heading"><p className="date-label">{admin ? "Dashboard admin" : "Dashboard trainer"}</p><h1>Clienti</h1><p>Invita, assegna un piano e controlla ultima seduta e Health.</p></header>
