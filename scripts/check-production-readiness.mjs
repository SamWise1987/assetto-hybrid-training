...
for (const migration of ["004_platform_foundation.sql", "005_privacy_hardening.sql", "006_notification_idempotency.sql", "007_onboarding_consent.sql", "008_pending_plan_activation_notification.sql", "009_health_metrics.sql"]) {
